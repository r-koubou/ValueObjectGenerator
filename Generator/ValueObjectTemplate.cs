...
#line hidden
 ...
 if( !string.IsNullOrEmpty( Namespace ) ) {
            ...
            #line hidden
            this.Write(">");
            this.Write(this.ToStringHelper.ToStringWithCulture(Option.HasFlag( OptionFlags.Comparable ) ? $", IComparable<{Name}>" : ""));
 ...
 if( Option.HasFlag( OptionFlags.Validate ) ) {
            ...
            #line default
            #line hidden
            this.Write("        protected virtual partial ");
            this.Write(this.ToStringHelper.ToStringWithCulture(BaseTypeName));
            ...
            #line hidden
            this.Write(" b )\n        {\n            if( a is null && b is null )\n            {\n                return false;\n            }\n            if( a is null || b is null )\n            {\n                return true;\n            }\n            return !a.Value.Equals( b.Value );\n        }\n\n        //----------------------------------------------------------------------\n        // ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Option.HasFlag( OptionFlags.Implicit ) ? "Implicit" : "Explicit"));
